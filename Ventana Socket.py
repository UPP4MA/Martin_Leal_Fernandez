...
class SocketApp:
    def __init__(self):
        ...
        self.connection_type_label = tk.Label(self.root, text="Conecciòn tipo Chat:")
        self.connection_type_label.pack(pady=5)

        self.connection_type_var = tk.StringVar()
        self.connection_type_var.set("Servidor")

        self.server_radio = tk.Radiobutton(self.root, text="Servidor", variable=self.connection_type_var, value="Servidor")
        self.server_radio.pack(anchor=tk.W)
        self.client_radio = tk.Radiobutton(self.root, text="Cliente", variable=self.connection_type_var, value="Cliente")
        self.client_radio.pack(anchor=tk.W)

        self.ip_label = tk.Label(self.root, text="Ingresa Direcciòn IP:")
